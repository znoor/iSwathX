...
#' @return a list of ggplot objects of statistical plots of the two libraries, also saved in working directory
#' @examples
...
plotStats <- function(datBaseLib, datExtLib, ...)
{
  ...
  ggsave("Protein_Peptide_Numbers.png", width = 6, height = 5)
  ...
  # dev.off()
    ...
    ggsave("Density_Plots.png", width = 6, height = 5)
    # dev.off()
  ###/////////////////////////////////////////////////////////////////////////////
    ...
    ggsave("Histogram_Peptide_Ion.png", width = 8, height = 5)
